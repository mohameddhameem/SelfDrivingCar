...
def simulate(params): 
    ...
    A = pd.read_excel('../rule/fuzzy_rule.xlsx', sheet_name = 'fuzzy_values')
    ...
    A.loc[9, 'c'] = params[8]
    A.loc[9, 'd'] = params[9]
    A.loc[10, 'c'] = params[10]
    A.loc[11, 'b'] = params[11]
    ...
    #from graphic import car # calling this to refresh the reading of excel file
    ...
    #from fuzzy_rule_base.read_rule import get_workbook, read_light_rule, read_impediment_rule
